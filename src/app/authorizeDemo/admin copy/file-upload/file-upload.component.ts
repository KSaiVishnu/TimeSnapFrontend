...
import { TimesheetUploadComponent } from "../../admin/import/timesheet-upload/timesheet-upload.component";
import { WorklogLeavesComponent } from "../worklog-leaves/worklog-leaves.component";

@Component({
  selector: 'app-file-upload',
  imports: [FormsModule, CommonModule, TimesheetUploadComponent, WorklogLeavesComponent],
